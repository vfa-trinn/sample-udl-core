...
public class Pausable : MonoBehaviour {
    ...
    void Pause() {
        ...
        PauseAnimators(animators, true);
        PauseParticles(particles, true);

        //behaviorTrees = transform.GetComponentsInChildren<BehaviorTree>();
    }

    public void PauseAnimators(Animator[] source, bool isPause)
    {
    ...
    public void PauseParticles(ParticleSystem[] source, bool isPause)
    {
        if (source == null) return;
        for (int i = 0; i < source.Length; i++)
        {
    ...
    void Resume() {
        ...
        PauseAnimators(animators, false);
        PauseParticles(particles, false);
    }
}